...
import com.piyaso.softforest.piyaso.Adapters.FavorateGridViewAdapter;
...
public class FavoriteFragment extends Fragment {
    ...
    FavorateGridViewAdapter favorateGridViewAdapter;
    ...
    public static FavoriteFragment newInstance(int pageNo) {
 ...
 View rootView= inflater.inflate(R.layout.fragment_favorite_fragmeny, container, false);
...
//        }
        ...
        favorateGridViewAdapter=new FavorateGridViewAdapter(getContext());
        gridview.setAdapter(favorateGridViewAdapter);
